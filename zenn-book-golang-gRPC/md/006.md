...
-   [`grpc.WithTransportCredentials(insecure.NewCredentials())`](https://pkg.go.dev/google.golang.org/grpc#WithTransportCredentials): コネクションでSSL/TLSを使用しない^[\[1\]](#fn-da8f-1){#fnref-da8f-1}^
