...
func main() {
	// このサンプル URL をパースするとします。 これは、
	// スキーム、認証情報、ホスト、ポート番号、パス、
	...
	// RawQuery を使います。 クエリパラメーターをマップとして
	// パースすることもできます。 パースされたクエリパラメーター
	// のマップは、文字列 → 文字列のスライスへのマップです。
	// そのため、最初の値だけ取得したければインデックス [0] を指定します。
