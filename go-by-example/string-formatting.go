...
func main() {
	...
	// 整数の例でも見ましたが、%x は文字列を 1 バイトにつき 2 文字の
	// 16 進数で表示することもできます。
	fmt.Printf("%x\n", "hex this")
	...
	// 思うでしょう。整数の幅を指定するためには、 フォーマット指定子の
	// % の後に数字を使います。 デフォルトでは、右寄せになり、
	// 空白でパディングされます。
	fmt.Printf("|%6d|%6d|\n", 12, 345)

	// 浮動小数の表示幅を指定することもできますが、 通常は幅だけでなく、
	// 小数点以下の精度も制限したいと思うでしょう。 width.precision
	// という構文で指定できます。
	...
	// ここまで、フォーマットされた文字列を os.Stdout に表示する
	// Printf 関数を見てきました。 Sprintf 関数は、フォーマット
	// した文字列をどこにも表示せず、 戻り値として返します。
